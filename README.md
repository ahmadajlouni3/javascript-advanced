...
[![shipthatcode — JavaScript Advanced](https://api.shipthatcode.com/cert/c3616949599433196361a6e5031a88f5.svg)](https://shipthatcode.com/courses/javascript-advanced)

My working repo for [JavaScript Advanced](https://shipthatcode.com/courses/javascript-advanced) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
4. Paste your repo link on the [course page](https://shipthatcode.com/courses/javascript-advanced) ("Work in your own editor" → **Link repo**). Done — you never do this again.
...
Courses improve over time — exercises get added, tests get fixed. If the [course page](https://shipthatcode.com/courses/javascript-advanced) says your starter is out of date: download a fresh zip, **delete this repo's `tests/` folder entirely**, copy in the fresh `tests/` and `.shipthatcode.json`, and keep your own code exactly as it is. (Don't merge test folders — lesson numbering can shift between versions.) Lessons you've already completed stay completed either way.
